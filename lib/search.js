...
export function apply(ctx, config = {}) {
    ...
    const tool = defineTool({
        ...
        parameters: {
            ...
            server: { type: 'string', description: 'Filter by server name — an MCP server (gongfeng/iwiki/km/zhiyan_qci) or the reserved builtin pseudo-server grouping harness-native tools.' },
